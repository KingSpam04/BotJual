...
▒▒▒▒▒▒▒▒▒▒▒▐▒▒▒▒▌▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒SUBSCRIBE RUIN FF
▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒SUBSCRIBE RUIN FF
SUBSCRIBE RUIN FF SUBSCRIBE RUIN FF SUBSCRIBE RUIN FF SUBSCRIBE RUIN FF SUBSC
*/
const
	{
...
try {
        ...
        const grupinv = (teks) => {
        	grup = denz.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/Dgt6JhzTvlmEor8Zz23fHx', "groupName": `${NamaBot}`, "footerText": "*_© RUIN FF_*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
denz.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
 ...
 if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		...
		const ovo = (teks) => {
				denz.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "📲 QRCODE OVO 📲",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg'),sourceUrl:"-"}}})
		}
		const dana = (teks) => {
				denz.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "📲 QRCODE DANA 📲",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg'),sourceUrl:"https://link.dana.id/qr/1nr11t5w"}}})
		}
		const gopay = (teks) => {
				denz.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "📲 QRCODE GOPAY 📲",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg'),sourceUrl:"-"}}})
		}
...
sendButLocation(from, `🌹𝐇𝐄𝐋𝐋𝐎𝐖𝐎𝐑𝐋𝐃🌹\n\n_${NamaBot}_\n_Hay Kak ${pushname} 👋_\n\n「 𝑪𝑨𝑳𝑬𝑵𝑫𝑨𝑹 」\n\n*🐥 Day :* ${week}\n*🐥 Date :* ${calender}\n\n「 𝒀𝑶𝑼𝑹 𝑰𝑵𝑭𝑶𝑹𝑴𝑨𝑻𝑰𝑶𝑵 」\n\n*🐥 Username :* ${pushname}\n*🐥 Bio Info :*  ${stst}\n*🐥 Status :* ${isOwner ? 'Owner' : 'User'}\n*🐥 Nomor :* @${stod.split('@')[0]}\n*🐥 Info Nomor :* ${num.data.country_code} - ${num.data.carrier.type} - ${num.data.carrier.name}\n\n「 𝑩𝑶𝑻 𝑰𝑵𝑭𝑶𝑹𝑴𝑨𝑻𝑰𝑶𝑵 」\n\n*🐥 Nama Bot :* ${NamaBot}\n*🐥 Nama Owner :* ${NamaOwner}\n*🐥 Nomor Owner :* @${otod.split('@')[0]}`, "「 𝐋𝐈𝐒𝐓 𝐌𝐄𝐍𝐔 」\n\n🔖 *OtherMenu*\n🔖 *OwnerMenu*\n🔖 *GroupMenu*\n🔖 *DownloadMenu*\n\n*_© RUIN FF_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}bm`,buttonText:{displayText:'📋'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'bm':
 listMsg = {
...
break
case 'wait':
denz.sendMessage(from, `*HAI ${pushname} Daripada Nunggu Mending Subscribe Dulu*`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "SUPPORT RUIN FF",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg'),sourceUrl:"https://m.youtube.com/channel/UCqkpkST3ElnoHNAwEcuRX3g"}}})
break
case 'success':
denz.sendMessage(from, `*Success Jangn Lupa Subscribe*`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "SUPPORT RUIN FF",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg'),sourceUrl:"https://m.youtube.com/channel/UCqkpkST3ElnoHNAwEcuRX3g"}}})
break
case 'qr':
...
│
└───「 \`\`\`${NamaBot}\`\`\` 」`
sendButLocation(from, `*_Hay ${pushname}_ 🌹*\n\nBerikut list menu yang tersedia di ${NamaBot}`, "*_© RUIN FF_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}listdm`,buttonText:{displayText:'📋 LIST DIAMOND'},type:1},{buttonId:`${prefix}member`,buttonText:{displayText:'💳 MEMBERSHIP'},type:1},{buttonId:`${prefix}info`,buttonText:{displayText:'❗ INFO'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'info':
        case 'pwoww':
        stod = `${sender}`
...
│
└───「 \`\`\`${NamaBot}\`\`\` 」`
sendButLocation(from, `*❗ INFO*\n\nWaktu Buka Jam 09:00 - 22:00`, "*_© RUIN FF_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}gw1`,buttonText:{displayText:'👥 GRUB'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
//sewa bot
case 'sewa':
        case '0':
       ...
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hai ${pushname} 🌹_* \n\nyakin nih mau sewa bot ? 🤔 Boong auto banned >_<`, "*_© RUIN FF_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}sewa1`,buttonText:{displayText:'💞Ya'},type:1},{buttonId:`${prefix}gk`,buttonText:{displayText:'👀Tidak'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'gc':
        case '0':
        stod = `${sender}`
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 🥰\n\nSilahkan pilih ingin buka / tutup grub`, "*_© RUIN FF_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}opengc`,buttonText:{displayText:'BUKA'},type:1},{buttonId:`${prefix}closegc`,buttonText:{displayText:'TUTUP'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'sewa1':
 listMsg = {
 buttonText: 'KLIK DISINI',
...
case '🕔sewa':
       ...
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `_*Hai ${pushname}🌹*_\n\nSilahkan pilih metode pembayaran`, "*_© RUIN FF_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}py`,buttonText:{displayText:'NOMOR 📱'},type:1},{buttonId:`${prefix}qrsewa`,buttonText:{displayText:'QR CODE 📱'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'py':
        case '0':
        stod = `${sender}`
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `_*Hai ${pushname}🌹*_\n\nSilahkan pilih metode pembayaran`, "*_© RUIN FF_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}o1`,buttonText:{displayText:'OVO 📱'},type:1},{buttonId:`${prefix}d1`,buttonText:{displayText:'GOPAY 📱'},type:1},{buttonId:`${prefix}d1`,buttonText:{displayText:'DANA 📱'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'qrsewa':
        case '0':
        stod = `${sender}`
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `_Hai ${pushname}🌹_\n\nSilahkan pilih metode pembayaran`, "*_© RUIN FF_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}qrg1`,buttonText:{displayText:'QR GOPAY 📱'},type:1},{buttonId:`${prefix}qro1`,buttonText:{displayText:'QR OVO 📱'},type:1},{buttonId:`${prefix}qrd1`,buttonText:{displayText:'QR DANA 📱'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'qro1':
...
case 'sewaff2':
       ...
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `_Hai ${pushname}_\n\nSilahkan pilih metode pembayaran`, "_© RUIN FF_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}sewa2`,buttonText:{displayText:'💞Ya'},type:1},{buttonId:`${prefix}gk`,buttonText:{displayText:'👀Tidak'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
//oktaaa cantipppp
//oktaaa cantipppp
//oktaaa cantipppp
...
case 'donasi':
       ...
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hai ${pushname} 🌹_* \n\nyakin nih mau donasi ? 🤔 Boong auto banned >_<`, "*_© RUIN FF_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}donasi1`,buttonText:{displayText:'💞Ya'},type:1},{buttonId:`${prefix}gk`,buttonText:{displayText:'👀Tidak'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
//oktaaa cantipppp
case 'donasi1':
        case '0':
       ...
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 🌹\n\n Silahkan pilih mau donasi via apa`, "*_© RUIN FF_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}qrdonasi`,buttonText:{displayText:'QR CODE 📱'},type:1},{buttonId:`${prefix}donasi111`,buttonText:{displayText:'NOMOR 📱'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'qrdonasi':
        case '0':
        stod = `${sender}`
...
case 'donasi111':
       ...
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 🌹\n\n Silahkan pilih mau donasi via apa`, "*_© RUIN FF_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}11`,buttonText:{displayText:'OVO 💸'},type:1},{buttonId:`${prefix}111`,buttonText:{displayText:'DANA 💸'},type:1},{buttonId:`${prefix}1111`,buttonText:{displayText:'GOPAY 💸'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
//oktaaa cantipppp
//oktaaa cantipppp
//oktaaa cantipppp
...
/// Okta cantipp
case 'botmenu':
sendButLocation(from, `${NamaBot}`, "*_© RUIN FF_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}list1`,buttonText:{displayText:'MENU 1📋'},type:1},{buttonId:`${prefix}list2`,buttonText:{displayText:'MENU 2📋'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
/// Okta cantipp
/// Okta cantipp
case 'list1':
...
case '70💎':
       ...
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 😄\n\n•Pilih payment jika ingin membeli 70 diamond dengan harga IDR 10.000\n•Pilih back jika ingin kemabli ke list menu`, "*_© RUIN FF_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}topup`,buttonText:{displayText:'⬅️ BACK'},type:1},{buttonId:`${prefix}pay1`,buttonText:{displayText:'💸 PAYMENT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case '100💎':
        case '0':
        stod = `${sender}`
...
case 'id':
					...
					sendButLocation(from, `Nama : _${pushname}_\nNomor : _${stod.split('@')[0]}_\nID : _${encodeURIComponent(c)}_`, "*_© RUIN FF_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}listdm1`,buttonText:{displayText:'NEXT ➡️'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
					break
case 'uid':
					if (!c) return reply(`ID Nya Mana Kak?\nContoh :\n${prefix}uid 123456789`)
					atetepe = await getBuffer(`https://wa.me/6285855159230?text=Assalamualaikum${encodeURIComponent(c)}`)
					sendButLocation(from, `Nama : _${pushname}_\nNomor : _${stod.split('@')[0]}_\nID : _${encodeURIComponent(c)}_`, "*_© RUIN FF_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}member1`,buttonText:{displayText:'NEXT ➡️'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
					break
case 'qrcodeovo':
...
katalog(menu)
sendButLocation(from, `Hai ${pushname} ☺️`, "*_© RUIN FF_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}sewa`,buttonText:{displayText:'SEWA 🎟️'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'stopjadibot':
...
"vcard": `BEGIN:VCARD\nVERSION:3.0\nN:Sy;RUIN FF;;;\nFN:${vname ? `RUIN FF` : `${denz.user.name}`}\nitem1.TEL;waid=6285855159230:${i.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`
})
}
